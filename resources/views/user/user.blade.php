    ...
    <div class="row">
        ...
        <div class="col-md-4">
          <div class="card" style="width: 18rem;">
            <div class="geeks">
                <img src="{{ asset('fotoproduk/'.$produk->gambar) }}" class="card-img-top" style="object-fit: cover; height: 310px;"></div>
                <div class="card-body">
                    ...
                    @csrf
                      <input type="number" name="jumlah" class="form-control" style="width: 110px; height:25px;" placeholder="jumlah" min="1" max="10">
                      <br>
