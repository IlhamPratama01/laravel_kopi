...
@foreach ($data as $produk)
            <form action="/produk/edit" method="post" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col">
                  <input type="text" class="form-control" name='id' required="required" value="{{ $produk->id }}" >
                </div>
                <label for="nama_produk" class="col-sm-2 col-form-label">Nama Produk</label>
                <div class="col">
                  <input type="text" class="form-control" name='nama_produk' required="required" value="{{ $produk->nama_produk }}" >
                </div>
                <label for="nama_produk" class="col col-form-label">Deskripsi</label>
                <div class="col">
                  <input type="text" class="form-control" name='deskripsi' required="required" value="{{ $produk->deskripsi }}" >
                </div>
                <label for="email" class="col-sm-2 col-form-label">Harga</label>
                <div class="col">
                  <input type="text" class="form-control" name='harga' required="required" value="{{ $produk->harga }}" >
                </div>
                  <div class="col-md-6 mb-3">
                <label for="stok" class="col-sm-2 col-form-label">Stok</label>
                <div class="col">
                  <input type="stok" class="form-control" name='stok' required="required" value="{{ $produk->stok }}" >
                </div>
                <div class="col-md-6 mb-3">
                ...
                <div class="col">
                    <input class="form-control" name="gambar" type="file" id="gambar" value="{{ $produk->gambar }}">
                      </div>
              </div>  
            </div>
          </div>
