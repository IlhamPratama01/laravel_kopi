              ...
              <div class="d-flex flex-wrap justify-content-xl-between">
                ...
                <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                  ...
                  <div class="d-flex flex-column justify-content-around">
                    ...
                    <h5 class="me-2 mb-0">Rp.{{ $transaksi->where('status','Selesai')->sum('grandtotal') }}</h5>
                  </div>
                </div>
                <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <h1>{{ $transaksi->groupBy('nama_produk')->map(function ($item, $pro) {
            return ['nama_produk' => $pro,'jumlah_pembelian' => $item->sum('jumlah')];})->sortByDesc('jumlah_pembelian')->first()['nama_produk'] }}</h1>
            <h4>Dengan jumlah penjualan</h4>
            <h5>{{ $transaksi->groupBy('nama_produk')->map(function ($item, $pro) {
              return ['nama_produk' => $pro,'jumlah_pembelian' => $item->sum('jumlah')];})->sortByDesc('jumlah_pembelian')->first()['jumlah_pembelian'] }} Cangkir</h5>
...
<footer class="footer">
  <div class="d-sm-flex justify-content-center justify-content-sm-center">
    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © bootstrapdash.com 2023</span>&nbsp;&nbsp;&nbsp;&nbsp;
